...
copy deploy\nuget\curve25519-uwp.targets %StagingPath%\build\native
...
REM copy curve25519\Release\curve25519\curve25519.winmd %StagingPath%\runtimes\win10-x86\native
...
REM copy curve25519\x64\Release\curve25519\curve25519.winmd %StagingPath%\runtimes\win10-x64\native
...
REM copy curve25519\ARM\Release\curve25519\curve25519.winmd %StagingPath%\runtimes\win10-arm\native
copy curve25519\ARM\Release\curve25519\curve25519.pri %StagingPath%\runtimes\win10-arm\native

REM create NuGet package
REM (Note: Expect 3 Assembly outside lib folder warnings, due to WinRT arch specific dlls)
